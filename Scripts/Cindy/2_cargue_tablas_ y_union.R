...
## esta es la adici�n de falla cuadrante y pivote 200
...
# 
# 
# ???? 1. Principio t�cnico (muy importante)
# 
# No todas las variables clim�ticas se agregan igual:
#   
#   Variable	Agregaci�n correcta	Justificaci�n
# Precipitaci�n	suma	es acumulativa
# Temperatura media	promedio	nivel promedio de exposici�n
# Temperatura m�xima	m�ximo	eventos extremos
# Temperatura m�nima	m�nimo	eventos extremos
# Humedad	promedio	estado atmosf�rico
# Viento	promedio + m�ximo (ideal)	nivel + r�fagas
...
clima_semana <- clima_semana %>%
  ...
  summarise(
    ...
    # Opcional (muy �til para robustez)
    dias_observados = n(),
