...
Aunque el título y el marco regulatorio del proyecto se refieren a SAIDI y SAIFI, en este trabajo no se predicen dichos indicadores en su forma regulatoria estricta. Lo que se modela es la frecuencia y la duración de las interrupciones eléctricas a escala de circuito o zona ---variables proxy asociadas a SAIFI y SAIDI, respectivamente---, coherente con la formulación del problema, los objetivos y la metodología. Este enfoque es suficiente para anticipar el comportamiento de la continuidad del servicio, priorizar mantenimiento y apoyar decisiones operativas; la estimación formal de SAIDI y SAIFI según las fórmulas de la CREG, con ponderación por usuarios afectados, queda fuera del alcance predictivo de este estudio.
...
\begin{itemize}
    ...
    % Estas siglas se deben explicar la 1era vez que las mencioanen. por lo menos en un
    % pie de página.
    %-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
Este problema no es exclusivo de la empresa analizada. En el sector eléctrico colombiano, la calidad del servicio constituye un desafío estructural. De acuerdo con el Informe de Calidad del Servicio de Energía Eléctrica de la SSPD 2023, el SAIDI promedio nacional fue de 16.83 horas por usuario, con valores que oscilaron entre 4.500 horas y más de 50 horas dependiendo del operador y de la región geográfica \cite{ref9}. Esta dispersión refleja diferencias significativas en infraestructura, gestión operativa y exposición a condiciones climáticas extremas. Durante 2023, el 68\% de las interrupciones estuvo asociado a eventos externos, como contacto con vegetación, animales o terceros, mientras que el 24\% se atribuyó a fallas técnicas en equipos de red, evidenciando la naturaleza multicausal del problema \cite{ref4}.
...
%-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
% Recuerden indicar que significa la sigla la primera vez que aparece
% y luego, solo seguir usando la sigla sin tener que repetir cada vez.
%-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
