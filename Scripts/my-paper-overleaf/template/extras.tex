...
\definecolor{commentsColor}{RGB}{36, 123, 161}  % Color para comentarios en tono azul oscuro
\definecolor{numColor}{RGB}{54, 81, 94}         % Color para los números en azul más oscuro
\definecolor{stringColor}{RGB}{0, 123, 167}     % Color para las cadenas en azul medio
\definecolor{kwColor}{RGB}{6, 85, 248}          % Color para las palabras clave en azul brillante
\definecolor{bgCodeColor}{RGB}{242, 248, 255}   % Color de fondo en un azul muy claro
