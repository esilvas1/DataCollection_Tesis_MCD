     ...
     \begin{enumerate}
          ...
          \item \textbf{Definición del SAIFI según la Resolución CREG 015 de 2018:}
           La misma resolución define el \textit{SAIFI} como:
            ...
            %-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
            % Aquí veo que aparece el OR, miren como mejorarlo para que no lo mencionen tan tarde.
            %-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX  
          ...
          \item \textbf{Interpretación de los indicadores:}
            ...
            %-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
            % Con esta definición hay que tener claridad, pues está en el objetivo
            % Cómo iría en el objetivo? anual? Debemos buscar consistencia en todo
            % el documento. Por lo menos aclarar cómo se usará en este trabajo.
            %-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX        
...
\end{enumerate}
%-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
% Aquí explicar matemáticamente los métodos o modelos que
% se implementen en el trabajo. No deben ser explicaciones
%genéricas, deben decir cuál es la vriable respuestas o predictores
% indicando cuáles serían en el contexto de este trabajo.
%-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
