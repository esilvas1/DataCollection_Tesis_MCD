...
\subsection{Feature engineering general}
\label{app:html-etapa4-01}
Informe \texttt{Etapa4\_01\_feature\_engineering\_general.html}: ingeniería de variables predictoras y preparación del diseño analítico.
\href{\urlEtapaCuatroUno}{Abrir informe}.

\subsection{Rezagos para SAIDI}
\label{app:html-etapa4-02}
Informe \texttt{Etapa4\_02\_rezagos\_SAIDI.html}: construcción y selección de rezagos temporales para modelar SAIDI.
\href{\urlEtapaCuatroDos}{Abrir informe}.
