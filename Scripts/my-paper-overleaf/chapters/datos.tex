Para el desarrollo del modelo de pronóstico de la frecuencia y la duración de interrupciones eléctricas (variables proxy asociadas a SAIDI y SAIFI), se utilizará una base de datos histórica de eventos de falla reportados en el sistema de distribución. La tabla principal consolidada tiene $N = 87{.}007{.}074$ observaciones ($A = 47{.}649$ activos eléctricos únicos $\times$ $T = 1{.}826$ días), correspondientes al panel \textbf{activo $\times$ día} entre el $1$ de enero de $2021$ y el $31$ de diciembre de $2025$.
