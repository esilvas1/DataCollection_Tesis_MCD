...
\begin{enumerate}
    ...
    $(\texttt{precip\_total\_semana},\,\texttt{n\_eventos})$, con $\rho_S\approx 0{.}41$ en $D_{\mathrm{mod}}$. Entre variables cualitativas se emplea el estadístico $V$ de Cramér~\textcite{ref54}. Para el agrupamiento jerárquico de covariables se usa la distancia $d=1-|\rho_S|$.
